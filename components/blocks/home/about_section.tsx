				...
				<div className="grid gap-6 sm:grid-cols-2 md:gap-6 lg:gap-12">
						...
						<div className="group bg-linear-to-b aspect-[76/59] relative overflow-hidden rounded-2xl from-zinc-300 to-transparent p-px transition-all duration-300 hover:from-primary/20 dark:from-zinc-700 dark:hover:from-primary/20">
							<div className="relative h-full w-full rounded-[15px] overflow-hidden">
								<Image
									...
									className="hidden h-full w-full object-cover rounded-[15px] transition-transform duration-500 group-hover:scale-105 dark:block"
									alt="Factory view dark"
									width={1333}
									height={702}
								/>
								<Image
									src="/factory_view.png"
									className="h-full w-full object-cover rounded-[15px] shadow transition-transform duration-500 group-hover:scale-105 dark:hidden"
					...
					<div className="relative space-y-4">
						<p className="text-foreground">
							...
							around 100 staff, we specialize in the production and development
							of surfactants and PVC additives. Our flagship product,{" "}
							...
							, and others. Our international trade department Hengtong Trading
							is based in Huangdao District, Qingdao, with a dedicated office to
							serve overseas clients efficiently and professionally.
						</p>
					</div>
				</div>
			</div>
