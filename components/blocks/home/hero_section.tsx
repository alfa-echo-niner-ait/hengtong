					...
					<div className="relative z-10 lg:w-1/2 space-y-8">
						...
						<div className="space-y-6">
							...
							<p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-lg">
								Cost-effective anionic surfactants with custom packaging
								solutions. We tailor our services to meet your project&apos;s
								unique requirements with precision and quality.
							</p>
						</div>
